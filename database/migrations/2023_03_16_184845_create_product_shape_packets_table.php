...
class CreateProductShapePacketsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_shape_packets', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_shape_packets');
    }
}
