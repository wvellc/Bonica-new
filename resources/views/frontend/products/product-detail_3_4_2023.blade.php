							...
							<div class="detials-wrapper-box">
								...
								<div class="mt-3">
                                    ...
                                    <div class="col-md-4 col-xl-5">
                                        ...
                                        <input type="hidden" name="shape" id="shape" value="{{$product->ProductShapes[0]['shape_id']}}">
                                        @endif
                                    </div>
								</div>
                                @endif
            ...
            success: function (data) {
                if(data.msg == 'success'){
                   ...
                   /*  $('#product_price').html(data.product_price);
                    ...
                    $('#diamondOnhand').attr('src', "{{asset('images/shapes')}}/"+$( "#shape option:selected" ).text().toLowerCase()+'.png');
