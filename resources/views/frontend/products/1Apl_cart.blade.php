						...
						<div class="col-md-12 col-xl-4 mt-5 mt-xl-0">
								...
								<ul id="cart-list">
                                    @foreach ($cartData as  $cart)
                                        @php
                                            ...
                                            //$product_price = $currency['symbol'].' '.number_format((float)($product_price * $cart->quantity) / $currency['rate'], 3, '.', '');
							...
							<div class="totals">
								<div class="totals-item">
									...
									<div class="totals-value" id="cart-subtotal">{!! $currency['symbol'].' '.number_format((float)($subtotal) / $currency['rate'], 3, '.', '') !!}</div>
								</div>
								...
								<div class="totals-item totals-item-total">
									<label>Total</label>
                                    <input type="hidden" name="hidden_cart_total" id="hidden_cart_total" value="{{number_format((float)(($subtotal - $discount) / $currency['rate']) + $shipping_charges, 3, '.', '')}}">
									<div class="totals-value" id="cart-total">{!! $currency['symbol'].' '.number_format((float)(($subtotal - $discount) / $currency['rate']) + $shipping_charges, 3, '.', '') !!}</div>
								</div>
							</div>
							<div class="inner-form-wrapper">
								<form>
