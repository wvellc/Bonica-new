                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 select-inner-design-wrapper multi-select-with-checkbo-wrapper d-none">
                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="card-body"
                                                                            ...
                                                                            @php
                                                                               ...
                                                                               // dd($ProductShapePackets);
                                                                                ...
                                                                                $selected_product_center_diamond_arr = array();
                                                                            ...
                                                                            @if ($ProductShapePackets)
                                                                                ...
                                                                                <div id="row-{{ $value['shape_id'] }}-{{ $packet_row }}">
                                                                                    <div class="row mb-2 align-items-center"
                                                                                        id="row">
                                                                                        <div class="col-md-7 mb-2 mb-md-0 ">
                                                                                            <div class="col-md-12 col-sm-12 select-inner-design-wrapper multi-select-with-checkbo-wrapper">
                                                                                                <div class="">
                                                                                                    {!! Form::select('center_diamonds_shape[' . $value['shape_id'] . '][]',$packet, $selected_product_center_diamond_arr, [
                                                                                                    'class' => 'form-control multipleselectshape',
                                                                                                    'multiple'=>'multiple',
                                                                                        ...
                                                                                        <div class="col-md-2 mb-2 mb-md-0 input-group">
                                                                                                ...
                                                                                                placeholder="Wt"
                                                                                                step = "any"
                                                                                                value="{{ $selected_product_center_diamond_weight }}" onkeyup="shapePacketPriceCalculation({{ $value['shape_id'] }},{{ $packet_row }}); grossWeightCalculat();">
                                                ...
                                                <div class="col-md-12 col-lg-12" id="side_diamonds_shape_id_1">
                                                    <div class="content box-content-wrapper">
                                                        <div class="card py-0" style="overflow: inherit;">
                                                            <div class="card-header ">
                                                                <div class="row align-items-center">
                                                                    <div class="col-md-12 col-12 order-3 order-md-2 " style="text-align: right;">
                                                            ...
                                                            @php
                                                                ...
                                                                $row_index_arr = array();
                                                                $side_d_wt_arr = array();
                                                                $side_d_pcs_arr = array();
                                                                $side_d_price_arr = array();
                                                                ...
                                                                if(count($ProductSideDiamondPackets) > 0){
                                                                    foreach ($ProductSideDiamondPackets as $key => $value) {
                                                                        ...
                                                                        $side_d_price_arr[$value['row_index']] = $value['packet']['price'];
                                                            ...
                                                            <div class="card-body" id="side_diamond_card_body_{{$key}}">
                                                                <div id="row-1-0">
                                                                    <div class="row mb-2 align-items-center"
                                                                        id="row">
                                                                        <div class="col-md-4 mb-2 mb-md-0 ">
                                                                            <div class="col-md-12 col-sm-12 select-inner-design-wrapper multi-select-with-checkbo-wrapper">
                                                                                <div class="">
                                                                                    ...
                                                                                    'class' => 'form-control multiple_select_side_diamonds_shape_1',
                                                                                    'multiple'=>'multiple',
                                                                        ...
                                                                        <div class="col-md-2 mb-2 mb-md-0 input-group">
                                                                                ...
                                                                                placeholder="Wt"
                                                                                step = "any"
                                                                                value="{{ $side_d_wt_arr[$key] }}" onkeyup="sideDiamondShapePacketPriceCalculation({{$key}});grossWeightCalculat();">
                                                                                <div class="input-group-append">
                                                                                    <span class="input-group-text">CT</span>
                                                                                </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-1 mb-2 mb-md-0 btndelete text-right  data-value="">
                                                                            <button id="" onclick="removeSideDiamondsShapeSelection('{{$key}}','{{$formObj->id}}')" class="btn btn-danger btn-sm remove-action  btn-action"
                                                            ...
                                                            <div class="card-body" id="side_diamond_card_body_{{$count_side_diamond_box}}">
                                                                <div id="row-1-0">
                                                                    <div class="row mb-2 align-items-center"
                                                                        id="row">
                                                                        <div class="col-md-4 mb-2 mb-md-0 ">
                                                                        ...
                                                                        <div class="col-md-2 mb-2 mb-md-0 input-group">
                                                                                ...
                                                                                placeholder="Wt"
                                                                                step = "any"
                                                                                value="" onkeyup="sideDiamondShapePacketPriceCalculation({{$count_side_diamond_box}});grossWeightCalculat();">
                                                                                <div class="input-group-append">
                                                                                    <span class="input-group-text">CT</span>
                                                                                </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-1 mb-2 mb-md-0 btndelete text-right d-none" data-value="">
                                                                            <button id="" onclick="removeSideDiamondsShapeSelection('{{$count_side_diamond_box}}')" class="btn btn-danger btn-sm remove-action  btn-action"
                                                                                title="Delete"><i class="fas fa-trash"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <input type="hidden" name="count_side_diamond_box" id="count_side_diamond_box" value="{{$count_side_diamond_box}}">
...
@push('js')
    ...
    <script>
        ...
        function addNewSideDiamondsPacket() {
            var countSideDiamondBox = $("#count_side_diamond_box").val();
                ...
                <div id="row-1-0">
                    <div class="row mb-2 align-items-center"
                        ...
                        <div class="col-md-4 mb-2 mb-md-0 ">
                            <div class="col-md-12 col-sm-12 select-inner-design-wrapper multi-select-with-checkbo-wrapper">
                                <div class="">
                                    ...
                                    'class' => 'form-control multiple_select_side_diamonds_shape_${countSideDiamondBox}',
                                    'multiple'=>'multiple',
                        ...
                        <div class="col-md-2 mb-2 mb-md-0 input-group">
                                ...
                                placeholder="Wt"
                                step = "any"
                                value="" onkeyup="sideDiamondShapePacketPriceCalculation(${countSideDiamondBox});grossWeightCalculat();">
                                <div class="input-group-append">
                                    <span class="input-group-text">CT</span>
                                </div>
                        </div>
            ...
            var countSideDiamondBoxAdd = parseInt(countSideDiamondBox) + 1;
            $("#count_side_diamond_box").val(countSideDiamondBoxAdd);
        }
