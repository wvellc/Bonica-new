			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						<small class="float-sm-right"><a class="btn btn-info bg-gradient-info" href="{{ route("admin.product.create") }}">
							Add {{$module}}
						</a></small>
					</div>
					<!-- /.card-header -->
...
<script>
		...
		var myTable =  $('#tbl_datatable').DataTable({
			...
			columns: [
                ...
                { data: 'subcategory', name: 'subcategory', orderable: false, searchable: true },
        ...
        function statusChange(id) {
            $.ajax({
                url: '{!! route("admin.product.statusupdate") !!}',
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
