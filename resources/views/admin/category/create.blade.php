                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="imgPreview">
                                    <img src="{{ URL::asset('uploads/category/'.$formObj->image) }}" width="200px" class="img-thumbnail" alt="Category">
                                </div>
                                @endisset
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-lg-4">
                        <div class="form-group">
                            ...
                            <div class="imgPreview">
                                <img src="{{ URL::asset('uploads/category/'.$formObj->shopthelook_image) }}" width="200px" class="img-thumbnail" alt="shopthelook_image">
                            </div>
                            @endif
                        </div>
                    </div>
