	...
	<div class="container-fluid">
		<div class="row mb-2">
			...
			<div class="col-sm-6">
                ...
                {{ Breadcrumbs::render("shape".$page_title) }}
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						<small class="float-sm-right"><a class="btn btn-info bg-gradient-info" href="{{ route("admin.shape.create") }}">
							Add {{$module}}
						</a></small>
					</div>
					<!-- /.card-header -->
...
<script>
        ...
        function statusChange(id) {
            $.ajax({
                url: '{!! route("admin.shape.statusupdate") !!}',
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
