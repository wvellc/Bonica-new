                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <small class="float-sm-right"><a class="btn btn-info bg-gradient-info" href="{{ route("admin.faq.create") }}">
                                    Add {{$module}}
                                </a></small>
                            </div>
...
<div class="modal fade" id="modal-contact-view">
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-header">
            <h4 class="modal-title" id="modal-title">FAQ Content</h4>
...
<script>
        ...
        function statusChange(id) {
            $.ajax({
                url: '{!! route("admin.faq.statusupdate") !!}',
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
