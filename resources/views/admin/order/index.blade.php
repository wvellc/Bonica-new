			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						{{-- <small class="float-sm-right"><a class="btn btn-info bg-gradient-info" href="{{ route("admin.order.create") }}">
							Add {{$module}}
						</a></small> --}}
					</div>
					<!-- /.card-header -->
...
<script>
		...
		var myTable =  $('#tbl_datatable').DataTable({
			...
			columns: [
                ...
                { data: 'shipping_charges', name: 'shipping_charges', orderable: false, searchable: false },
        ...
        function statusChange(id) {
            $.ajax({
                url: '{!! route("admin.order.statusupdate") !!}',
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
