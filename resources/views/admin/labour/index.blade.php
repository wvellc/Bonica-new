			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						<small class="float-sm-right"><a class="btn btn-info bg-gradient-info" href="{{ route("admin.labour.create") }}">
							Add {{$module}}
						</a></small>
					</div>
					<!-- /.card-header -->
...
<script>
        ...
        function statusChange(id) {
            $.ajax({
                url: '{!! route("admin.labour.statusupdate") !!}',
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    "id": id
