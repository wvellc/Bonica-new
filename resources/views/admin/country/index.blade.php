			...
			<div class="col-md-12">
				...
				<div class="card card-info">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="rate[{{$country->slug}}]" id="{{$country->id}}" class="form-control" value="{{$country->rate}}">
					...
					<div class="card-footer">
						...
						<a href="{{ route('admin.country.index') }}" class="btn btn-danger icon-btn">Cancel</a>
					</div>
					{{ Form::close() }}
</div>
<!-- /.card -->
