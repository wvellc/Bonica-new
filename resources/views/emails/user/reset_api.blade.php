													...
													<tbody>
														<tr>
															<td style="box-sizing: border-box;">
																<a href="{{ route('api.password.reset', $token) }}" class="x_-1952022034m_1290543836343082458button" style="box-sizing: border-box;border-radius: 4.0px;color: #FFFFFF;display: inline-block;overflow: hidden;text-decoration: none;background-color: #40485b;border-bottom: 8.0px solid #40485b;border-left: 18.0px solid #40485b;border-right: 18.0px solid #40485b;border-top: 8.0px solid #40485b;" target="_blank">Reset Password</a>
															</td>
														</tr>
													</tbody>
												</table>
