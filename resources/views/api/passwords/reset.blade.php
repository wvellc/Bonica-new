@extends('api.layouts.layout')
@section('content')
@include('admin.layouts.alert_message')

{{ Form::open(array('url' => route('api.password.reset.store'),'method'=>'post')) }}
...
<div class="row">
	...
	<!-- /.col -->
	<div class="col-6">
		<button type="submit" class="btn btn-info btn-block">{{ __('Update Password') }}</button>
	</div>
	<!-- /.col -->
</div>
{{ Form::close() }}
